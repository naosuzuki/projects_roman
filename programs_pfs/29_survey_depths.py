...
def build_figure(hero_fs=17):
    ...
    ax.set_xlabel(r"Survey Area  (Arcmin$^2$)", fontsize=18)
    ...
    axtop.set_xlabel(r"Survey Area  (Deg$^2$)", fontsize=18)
    axtop.tick_params(axis="x", which="both", direction="in", labelsize=16)
