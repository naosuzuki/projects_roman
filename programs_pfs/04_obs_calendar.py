...
def main():
    ...
    if args.phase_labels:
        ...
        axtop.tick_params(axis="x", bottom=True, labelbottom=False)
        # (tick date, text date, label): the text may start left of the tick
        PHASES = (("2027-04-15", "2027-03-01", "Phase-I HSC"),
                  ("2028-06-01", "2028-06-01", "Phase-II PFS"),
                  ("2030-07-01", "2030-07-01", "Phase-III PFS"))
